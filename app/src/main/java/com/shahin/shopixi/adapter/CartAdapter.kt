...
import com.shahin.shopixi.databinding.EachCartBinding

import com.shahin.shopixi.model.Product
import com.shahin.shopixi.view.ProductDetailsActivity
import com.shahin.shopixi.viewmodel.CartViewModel
...
class CartAdapter(
    ...
    interface Listener {
        fun onItemClick(products: Product)//service : Service de
    }
