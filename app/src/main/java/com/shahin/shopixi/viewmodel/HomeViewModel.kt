...
import com.shahin.shopixi.data.Image
import com.shahin.shopixi.data.ImageDatabase
import com.shahin.shopixi.data.ProductDatabase
import com.shahin.shopixi.model.BaseClass
import com.shahin.shopixi.model.Product
import com.shahin.shopixi.service.ProductsAPI
import com.shahin.shopixi.utils.CustomSharedPreferences
import com.shahin.shopixi.view.MainActivity
...
class HomeViewModel : ViewModel() {
    ...
    fun storeInSQLite(context: Context, products: ArrayList<Product>) {
        ...
        viewModelScope.launch {
            ...
            products.forEach {
                val aProduct = com.shahin.shopixi.data.Product(it.id,it.title,it.description,it.price,it.discountPercentage,it.rating,it.stock,it.brand,it.category,
                it.thumbnail)
